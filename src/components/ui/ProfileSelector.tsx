...
const DEFAULT_PROFILES: Profile[] = [
  ...
  { id: "qa", name: "QA Engineer", description: "Quality assurance, bug fixing, testing" },
  { id: "devops", name: "DevOps Engineer", description: "Infrastructure, deployment, CI/CD" },
  { id: "swe-backend", name: "SWE Engineer", description: "Feature development, code improvement" },
  ...
  { id: "support", name: "Support Agent", description: "Research, legal, security" },
];

export default function ProfileSelector({ value, onChange, compact = false, placeholder }: ProfileSelectorProps) {
  ...
  useEffect(() => {
    ...
    fetch("/api/agent/profiles", { signal: controller.signal })
      ...
      .then((d) => {
        ...
        if (raw.length > 0) {
          // Map live profiles to our shape; use name/description as-is
